          ...
          <div className="flex flex-col md:flex-row items-center justify-center mt-10 gap-10">
            ...
            >
              <p className="mt-2 text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
                I’m <span className="font-semibold">Siyamregn Yeshidagna</span>, 
                a <span className="font-semibold">Full-Stack Developer</span> with a <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500">Bachelor's degree in 
                Computer Engineering</span>. I have a strong background in building modern, 
                scalable, and user-friendly web applications, turning ideas into digital solutions that 
                make a real impact.
              </p>
